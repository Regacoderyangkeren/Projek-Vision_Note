...
<html lang="en">
    ...
    <body>
        <div class="Login-Container">
            ...
            <div class="Sign-Up"> <p> Or, you're new? Then <strong> <a href="SignUp_Page.php"> Sign Up </a> </strong> </p> </div>
            ...
            <form method="POST" action="Login_Process.php">
                <div class = "User-account-fill">
                    <input type="text" name="UsernameOrEmail" required placeholder="Username atau Email">
